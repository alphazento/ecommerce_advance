...
namespace ZentoAdv\ElasticSuit\Elasticsearch\Schema;
...
use ZentoAdv\ElasticSuit\Elasticsearch\Schema\Blueprint;
...
class Builder extends \Illuminate\Database\Schema\Builder
{
     ...
     * @return void
     */
    public function __construct(\ZentoAdv\ElasticSuit\Elasticsearch\Connection $connection)
    {
