...
namespace ZentoAdv\ElasticSuit\Elasticsearch;
...
use ZentoAdv\ElasticSuit\Elasticsearch\Query\Grammar\Grammar;
use ZentoAdv\ElasticSuit\Elasticsearch\Query\Processors\Processor;
...
class Connection extends BaseConnection
{
     ...
     *
     * @param  string  $table
     * @return \ZentoAdv\ElasticSuit\Elasticsearch\Query\Builder
     */
